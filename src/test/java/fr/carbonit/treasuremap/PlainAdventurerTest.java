...
class PlainAdventurerTest {
    ...
    void should_return_Lara_on_0_3_with_south_orientation_and_3_treasures() {
        ...
        // When
        Adventurer plainAdventurer = new PlainAdventurer(name, new Point(0, 3), orientation, new ArrayDeque<>());
    ...
    void should_move_to_1_2_when_orientation_is_S_and_action_is_A_and_initial_position_is_1_1() {
        ...
        actions.add("A");
        Adventurer plainAdventurer = new PlainAdventurer(name, new Point(1, 1), orientation, actions);
        // When
